...
#samples_by_cluser_assignment = [cl_assignment[:, np.newaxis] * rng.multivariate_normal(cl_center, np.eye(2), size=n_samples)
#      for cl_assignment, cl_center in zip(cluster_assignments, cluster_centers)]
